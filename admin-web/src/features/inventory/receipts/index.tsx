    ...
    <>
      ...
      <Main>
        <div className='mb-4 flex items-center justify-between'>
          <h1 className='text-2xl font-bold'>{t('inventory.receipt.title')}</h1>
          ...
          <div className='space-y-4'>
            <div>
              ...
              <Select value={form.type} onValueChange={(v) => setForm({ ...form, type: v })}>
                ...
                <SelectContent>
                  <SelectItem value='purchase'>{t('inventory.receipt.purchaseReceipt')}</SelectItem>
                  <SelectItem value='return'>{t('inventory.receipt.returnReceipt')}</SelectItem>
                  <SelectItem value='transfer'>{t('inventory.receipt.transferReceipt')}</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div>
