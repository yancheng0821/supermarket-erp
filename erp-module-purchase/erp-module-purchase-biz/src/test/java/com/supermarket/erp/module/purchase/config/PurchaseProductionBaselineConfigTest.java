package com.supermarket.erp.module.purchase.config;
...
class PurchaseProductionBaselineConfigTest {

    private final YamlPropertySourceLoader yamlLoader = new YamlPropertySourceLoader();

    @Test
    void purchaseProfileFiles_shouldExposeProductionBaseline() throws IOException {
        ...
        assertThat(base.getProperty("spring.application.name")).isEqualTo("erp-purchase");
        ...
        assertThat(base.getProperty("logging.file.path")).isEqualTo("${ERP_PURCHASE_LOG_PATH:./logs/erp-purchase}");
    ...
    @Test
    void purchaseLocalProfile_shouldDisableNacosAndExternalizeDatasourceSecrets() throws IOException {
    ...
    @Test
    void purchaseLogback_shouldSeparateAccessAndAsyncFileAppenders() throws IOException {
        String logback = readTextResource("logback-spring.xml");

        assertThat(logback).contains("<springProperty scope=\"context\" name=\"APP_NAME\" source=\"spring.application.name\" defaultValue=\"erp-purchase\"/>");
