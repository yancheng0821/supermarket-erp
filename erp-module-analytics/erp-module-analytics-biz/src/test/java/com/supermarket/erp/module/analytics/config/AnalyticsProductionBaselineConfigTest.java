package com.supermarket.erp.module.analytics.config;
...
class AnalyticsProductionBaselineConfigTest {

    private final YamlPropertySourceLoader yamlLoader = new YamlPropertySourceLoader();

    @Test
    void analyticsProfileFiles_shouldExposeProductionBaseline() throws IOException {
        ...
        assertThat(base.getProperty("spring.application.name")).isEqualTo("erp-analytics");
        ...
        assertThat(base.getProperty("logging.file.path")).isEqualTo("${ERP_ANALYTICS_LOG_PATH:./logs/erp-analytics}");
    ...
    @Test
    void analyticsLocalProfile_shouldDisableNacosAndExternalizeDatasourceSecrets() throws IOException {
    ...
    @Test
    void analyticsLogback_shouldSeparateAccessAndAsyncFileAppenders() throws IOException {
        String logback = readTextResource("logback-spring.xml");

        assertThat(logback).contains("<springProperty scope=\"context\" name=\"APP_NAME\" source=\"spring.application.name\" defaultValue=\"erp-analytics\"/>");
