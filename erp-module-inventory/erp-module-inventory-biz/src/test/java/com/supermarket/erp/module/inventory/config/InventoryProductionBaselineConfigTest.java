package com.supermarket.erp.module.inventory.config;
...
class InventoryProductionBaselineConfigTest {

    private final YamlPropertySourceLoader yamlLoader = new YamlPropertySourceLoader();

    @Test
    void inventoryProfileFiles_shouldExposeProductionBaseline() throws IOException {
        ...
        assertThat(base.getProperty("spring.application.name")).isEqualTo("erp-inventory");
        ...
        assertThat(base.getProperty("logging.file.path")).isEqualTo("${ERP_INVENTORY_LOG_PATH:./logs/erp-inventory}");
    ...
    @Test
    void inventoryLocalProfile_shouldDisableNacosAndExternalizeDatasourceSecrets() throws IOException {
    ...
    @Test
    void inventoryLogback_shouldSeparateAccessAndAsyncFileAppenders() throws IOException {
        String logback = readTextResource("logback-spring.xml");

        assertThat(logback).contains("<springProperty scope=\"context\" name=\"APP_NAME\" source=\"spring.application.name\" defaultValue=\"erp-inventory\"/>");
