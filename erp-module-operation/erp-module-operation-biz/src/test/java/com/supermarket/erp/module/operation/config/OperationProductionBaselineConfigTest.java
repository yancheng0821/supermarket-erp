package com.supermarket.erp.module.operation.config;
...
class OperationProductionBaselineConfigTest {

    private final YamlPropertySourceLoader yamlLoader = new YamlPropertySourceLoader();

    @Test
    void operationProfileFiles_shouldExposeProductionBaseline() throws IOException {
        ...
        assertThat(base.getProperty("spring.application.name")).isEqualTo("erp-operation");
        ...
        assertThat(base.getProperty("logging.file.path")).isEqualTo("${ERP_OPERATION_LOG_PATH:./logs/erp-operation}");
    ...
    @Test
    void operationLocalProfile_shouldDisableNacosAndExternalizeDatasourceSecrets() throws IOException {
    ...
    @Test
    void operationLogback_shouldSeparateAccessAndAsyncFileAppenders() throws IOException {
        String logback = readTextResource("logback-spring.xml");

        assertThat(logback).contains("<springProperty scope=\"context\" name=\"APP_NAME\" source=\"spring.application.name\" defaultValue=\"erp-operation\"/>");
